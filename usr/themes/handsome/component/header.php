...
<head>
    ...
    <script type="text/javascript">
        ...
        window['LocalConst'] = {
            ...
            THEME_DARK_MODE_VALUE: '<?php echo(@$this->options->dark_setting == "" ? "light" :
                $this->options->dark_setting)
                ?>',
            SHOW_SETTING_BUTTON: '<?php echo(in_array('showSettingsButton', $this->options->featuresetup) || $dark_setting == "auto")?>',
    ...
    <link rel="stylesheet"
          ...
          type="text/css"/>
    <link rel="stylesheet"
          href="<?php echo STATIC_PATH; ?>css/github-markdown-css-for-blog.css?v=<?php echo Handsome::version . Handsome::$versionTag ?>"
          type="text/css"/>
