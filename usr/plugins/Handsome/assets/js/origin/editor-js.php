...
<<<<<<< HEAD:usr/plugins/Handsome/assets/js/origin/editor-js.php

        body {
=======
        body{
>>>>>>> 12177ad2b7c543da838558647f6b4e552c8998f9:usr/plugins/Handsome/assets/js/origin/editor-js.php
            position: relative;
        }
    </style>
    <?php
...
=======
    ...
    $cssUrl = $options->pluginUrl . '/Handsome/assets/css/index.min.css?v=8.2.0';
    $jsUrl = $options->pluginUrl . '/Handsome/assets/js/index.min.js?v=8.2.0';
